...
public class MacbethTest {
        ...
        public static void main (String[]args)
        {
            ...
            try {
                ...
                reader = new BufferedReader(new FileReader(dir + "/macbeth.txt"));
                ...
                System.out.println("The second most popular 4 character word is :");
                for (Entry<String, Integer> entry : list) {
                    if ((entry.getValue() > 92) && (entry.getValue() < 94) && (entry.getKey().equals("macduff")))
                    {
